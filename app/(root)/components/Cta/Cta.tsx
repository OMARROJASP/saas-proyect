                ...
                <div className='max-w-4xl mx-auto text-center space-y-8'>
                    <div className='space-y-4'>
                        ...
                        <p className='text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed'>
                            Join thousands of developers who ve transformed their interview skills and landed
                            their dream jobs. Start practicing today. 
                        </p>          
                    </div>
                    ...
                    <div className='grid md:grid-cols-3 gap-8 mt-16 pt-16 border-t border-border/50'>
                        {
                        cta.map((c) => (
                        <div className='text-center'  key={c.name}>
                            <div className='text-3xl font-bold text-primary mb-2'>{c.quanty}</div>
